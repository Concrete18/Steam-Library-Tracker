    ...
    def requests_loop(self, skip_filled=1, check_status=0):
        ...
        try:
            ...
            for game_name in tqdm(
                ...
                if not self.games.get_cell(game_name, self.time_to_beat_column):
                ...
                if not self.games.get_cell(game_name, self.metacritic_column):
